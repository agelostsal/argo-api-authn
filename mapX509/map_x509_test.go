...
func (suite *MapX509Suite) TestMapX509ToAuthItem() {
	...
	serviceType1 := servicetypes.ServiceType{"s1", []string{"host1", "host2", "host3"}, []string{"x509", "oidc"}, "mock-api-key", "uuid1", "2018-05-05T18:04:05Z", "ams"}
	...
	serviceType2 := servicetypes.ServiceType{"s1", []string{"host1", "host2", "host3"}, []string{"x509", "oidc"}, "mock-api-key-500", "uuid1", "2018-05-05T18:04:05Z", "ams"}
	...
	//serviceType3 := servicetypes.ServiceType{"s1", []string{"host1", "host2", "host3"}, []string{"x509", "oidc"}, "mock-api-key", "uuid1",  "2018-05-05T18:04:05Z", "ams"}
